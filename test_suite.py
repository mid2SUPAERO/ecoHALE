...
class TestAeroStruct(unittest.TestCase):
    ...
    def test_aerostruct_optimization(self):
        ...
        self.assertAlmostEqual(prob['wing_post_solve.failure'], 1e-9)
    ...
    def test_aerostruct_optimization_symmetry_multiple(self):
        ...
        self.assertAlmostEqual(prob['wing_post_solve.failure'], 1e-9)
        self.assertAlmostEqual(numpy.linalg.norm(prob['wing.twist_cp']), numpy.linalg.norm(prob['tail.twist_cp']), places=3)
