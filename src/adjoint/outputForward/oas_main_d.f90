...
! taper
    ...
    if (symmetry) then
      ...
      do iy=1,ny
        do ix=1,nx
          do ind=1,3
            meshd(ix, iy, ind) = meshd(ix, iy, ind)*taper_lins(ny-iy+1) &
&              + (mesh(ix, iy, ind)-quarter_chord(iy, ind))*taper_linsd(&
&              ny-iy+1)
...
&                taper_lins_symd)
      ...
      do iy=1,ny
        do ix=1,nx
          do ind=1,3
            meshd(ix, iy, ind) = meshd(ix, iy, ind)*dx(ny-iy+1) + (mesh(&
&              ix, iy, ind)-quarter_chord(iy, ind))*dxd(ny-iy+1)
            mesh(ix, iy, ind) = (mesh(ix, iy, ind)-quarter_chord(iy, ind&
...
! working
    ...
    real(kind=8) :: smeshd(nx, ny, 3), td(3, 3), t_based(3, 3), vecd(3)
