...
for case_name, case_data in db.iteritems():
    ...
    thickness.append(case_data['Unknowns']['t'][n21:])
...
for i, (t_vals, l_vals, m_vals, h_vals) in enumerate(zip(twist, lift, mesh, thickness)):
    ...
    ax3.plot(span_diff, h_vals, lw=2, c=plt.cm.jet(i/n_cases))
    ...
    ax3.set_ylabel('thickness', rotation="horizontal", ha="right")
