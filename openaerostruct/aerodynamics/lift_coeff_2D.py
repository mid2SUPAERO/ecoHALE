...
class LiftCoeff2D(ExplicitComponent):
    ...
    def setup(self):
        ...
        self.add_input('sec_forces', val=np.random.random((self.nx-1, self.ny-1, 3)))
        self.add_input('widths', val=np.random.random((self.ny-1)))
        self.add_input('chords', val=np.random.random((self.ny)))
