...
from openaerostruct.transfer.load_transfer_grp import load_transfer_grp 
...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        comp = load_transfer_grp(surface=surface)
        ...
        group.add_subsystem('load_transfer_grp', comp, promotes=['*'])
