...
class Test(unittest.TestCase):
    ...
    def test(self):
        ...
        self.assertAlmostEqual(prob['AS_point_0.wing_perf.CL'][0], 0.469152412337, places=0)
        self.assertAlmostEqual(prob['AS_point_0.fuelburn'][0], 95396.2868311, places=0)
        self.assertAlmostEqual(prob['AS_point_0.wing_perf.failure'][0], 0., places=4)
        self.assertAlmostEqual(prob['AS_point_0.CM'][1], -0.13357819566, places=2)
