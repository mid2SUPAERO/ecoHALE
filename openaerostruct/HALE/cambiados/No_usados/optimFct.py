...
#    night_hours=hours #h #ED2
    ...
    surf_dict = {
                ...
                'fem_model_type' : 'wingbox', # 'wingbox' or 'tube'                'data_x_upper' : upper_x,
...
#                't_over_c_cp' : np.array([0.08, 0.08, 0.10, 0.08]),
    ...
    #            'mrho' : 2.80e3,           # [kg/m^3] material density                'strength_factor_for_upper_skin' : 1.0, # the yield stress is multiplied by this factor for the upper skin
...
#                'Wf_reserve' :15000.,       # [kg] reserve fuel mass                'puissanceMM' : 1,    #power used in muli-material function
    #            'mrho' : 2000.,
#                'span' : 50., #[m]
                'span' : span, #[m]
...
#    prob.model.connect('wing.taper', 'emittedco2.taper') #TODELETE    #    prob.model.connect('wing.geometry.t_over_c_cp', 'emittedco2.t_over_c') #TODELETE    
