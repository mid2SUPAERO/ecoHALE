...
def fctOptim(mrhoi,puissanceMM,limbasserho,limhauterho): 
#def fctOptim(mrhoi,hours,limbasserho,limhauterho):  #ED2
...
#    prob.model.add_design_var('mrho', lower=1400, upper=9900, scaler=0.001) #ED
    prob.model.add_design_var('mrho', lower=limbasserho, upper=limhauterho, scaler=0.001) #ED
