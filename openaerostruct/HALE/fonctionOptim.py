...
def fctOptim(mrhoi,skin,spar,span,toverc): 
    ...
    gfrp=material(1860,21.4e9,8.14e9,255e6/1.5,6.18,"gfrp")            #epoxy-Eglass,woven,QI
    ...
    indep_var_comp.add_output('engine_location', val=np.array([-0.3]))  # 1 motor (half of the wing)
    #indep_var_comp.add_output('engine_location', val=np.array([-0.3,-0.6]))  # 2 motors (half of the wing)
