...
point_mass_location=[]  # Position of each motor [m]
...
point_mass=[]  # Mass of each motor [kg]
...
for i in range(iterations):
    ...
    point_mass_location.append(case.outputs['point_mass_locations'][0])
    motor_location.append(design_vars['engine_location'])
    ...
    point_mass.append(case.outputs['point_masses'][0])
