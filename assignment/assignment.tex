...
\begin{document}
	...
	\be
		...
		\be
			...
			mesh sizes (9) and (13) and compare run times. Then try to run
		...
		\be
			...
			but comment out the settings near the bottom of the file to switch on
			...
			\item Now that you've run the aerostructural optimization case, experiment with the different solver parameters and design variable options to find the optimum in the fewest number of function evaluations.
			You must keep the same design variables, objective, and constraints as in part c, but you are free to vary the solver setup, parameter scaling, and optimizer settings.
