...
\begin{document}
	...
	\be
		...
		\be
			...
			the problem with the newton solver on the root group instead For this problem work 
			with \code{prob2b.py}. Why do we put the nonlinear solver on the `coupled` group, 
